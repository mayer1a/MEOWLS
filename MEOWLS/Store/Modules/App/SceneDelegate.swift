...
//  MEOWLS
//
//  Created by Artem Mayer on 02.06.2024.
//
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene,
        ...
        window?.rootViewController = Router.introViewController()
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        ...
        guard lastUserActivity.timeIntervalSinceNow < -SceneDelegate.pincodeRequestTimeout else {
